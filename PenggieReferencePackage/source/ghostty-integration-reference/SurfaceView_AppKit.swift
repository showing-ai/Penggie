...
extension Ghostty {
    ...
    class SurfaceView: OSSurfaceView, Codable, Identifiable {
        ...
        func readVisibleContents() -> String {
        ...
        func readScreenContentsVT() -> String {
            guard let surface else { return "" }
        ...
        func readScreenModelJSON() -> String {
            ...
            guard ghostty_surface_read_screen_model(surface, &text) else { return "" }
